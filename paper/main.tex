...
% Style
\setcounter{tocdepth}{1} % ToC max depth
...
\def\subtitle{A comparison of three symbolic model tools for formal verification:\\Tamarin-prover, Verifpal and Proverif}
